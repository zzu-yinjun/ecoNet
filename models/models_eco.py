...
def register_hier_output(model):
    ...
    def forward(x, timesteps=None, context=None, y=None, **kwargs):
        ...
        for module in self.input_blocks:
            ...
            h = module(
                h, emb, context
            )  ## suraj: error happening inside kitti at this line
            hs.append(h)
...
class UNetWrapper(nn.Module):
    ...
    def forward(self, *args, **kwargs):
        ...
        if self.use_attn:
            ...
            attn16, attn32, attn64 = self.process_attn(
                avg_attn
            )  # in nyu, error is happening inside this fun
...
class EmbeddingAdapter(nn.Module):
    def __init__(self, emb_dim=768):
        ...
        self.fc = nn.Sequential(
            nn.Linear(emb_dim, emb_dim), nn.GELU(), nn.Linear(emb_dim, emb_dim)
        )
